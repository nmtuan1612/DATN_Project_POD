              ...
              <div className='flex items-center'>
                ...
                <div>
                  ...
                  >
                    ...
                    <img className='h-8 w-8 rounded-full' src={snap.profile.picture} alt='user photo' />
                  </button>
                  {/* Dropdown menu */}
                  <div
                    className='z-30 my-4 hidden list-none divide-y divide-gray-100 rounded-lg bg-white text-base shadow-around'
                    id='user-dropdown'
                  >
                    <div className='px-4 py-3'>
                      <span className='block text-sm text-gray-900'>{snap.profile.name}</span>
                      <span className='block truncate  text-sm text-gray-500'>{snap.profile.email}</span>
                    </div>
